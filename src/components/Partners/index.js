...
const PartnersSection = () => {
    return (
        <PartnersContainer>
            ...
            <PartnersWrapper>
                <MemberCard>
                    <MemberPhoto src={`${process.env.PUBLIC_URL}/images/wolo.png`}/>
                    <MemberContent>
                ...
                <MemberCard>
                    <MemberPhoto src={`${process.env.PUBLIC_URL}/images/nabila.png`}/>
                    <MemberContent>
                ...
                <MemberCard>
                    <MemberPhoto src={`${process.env.PUBLIC_URL}/images/chelsea.png`}/>
                    <MemberContent>
                ...
                <MemberCard>
                    <MemberPhoto src={`${process.env.PUBLIC_URL}/images/kemal.png`}/>
                    <MemberContent>
